...
// WiFiServer server(80); // Khởi tạo một server trên cổng 80
...
//     Serial.println(F("Unable to connect to DFPlayer Mini"));
//     while (true);
//   }
...
//         Serial.println(request); // Display the data on Serial Monitor
//       }
//     }
...
//     if (request != "") {
//       Serial.println("Đã vào");
//       dfplayer.play(request.toInt()); // Phát file có ID là 1 
//       delay(5000); // Đợi 5 giây  
//       dfplayer.pause(); // Tạm dừng phát file
//       delay(2000); // Đợi 2 giây trước khi phát lại
//     }
//   }
// }
